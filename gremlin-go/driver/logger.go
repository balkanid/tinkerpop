...
import (
	...
	"github.com/balkanid/tinkerpop/gremlin-go/v3/driver/resources"
...
const (
	...
	poolConnectionExpiredClosing  errorKey = "POOL_CONNECTION_EXPIRED_CLOSING"
	poolConnectionExpiredDeferred errorKey = "POOL_CONNECTION_EXPIRED_DEFERRED"
	poolConnectionExpiredReplaced errorKey = "POOL_CONNECTION_EXPIRED_REPLACED"
)
